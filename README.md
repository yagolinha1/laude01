...
Este é um projeto de fotografia desenvolvido em HTML e CSS. Ele exibe imagens de diferentes tamanhos em um layout de grid responsivo.
...
- O cabeçalho exibe o título "Fotografia nexstage".
...
```bash
git clone https://github.com/yagolinha1/gridpics.git
```
...
Este projeto foi desenvolvido por [YAGO LUIZ SOUZA SILVA](https://github.com/yagolinha1).
